...
module.exports = {
	...
	'Field appears in Presenter': function(browser) {
		...
		editor.navigate()
			...
			.fo_expand()
			.set_fo_description(test)
			.set_fo_description_lang(lang_label)
			.select();
		...
		presenter
			.assert_fo_description(test)
			.assert_fo_description_lang(lang_value);
	...
	'Upload appears in Presenter': function(browser) {
		...
		presenter
			.assert_fo_description(test_upload)
			.assert_fo_description_lang(def_lang_value);
	},
	...
	'Upload appears in Editor': function(browser) {
		...
		editor
			.assert_fo_description(test_upload)
			.assert_fo_description_lang(def_lang_label);
	},
