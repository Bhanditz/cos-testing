...
module.exports = {
	...
	'Field appears in Presenter': function(browser) {
		...
		presenter
			.assert_ip_name(test)
			.assert_ip_name_lang(lang_value);
	...
	'Upload appears in Presenter': function(browser) {
		...
		presenter
			.assert_ip_name(test_upload)
			.assert_ip_name_lang(def_lang_value);
	},
	...
	'Upload appears in Editor': function(browser) {
		...
		editor
			.assert_ip_name(test_upload)
			.assert_ip_name_lang(def_lang_label);
	},
