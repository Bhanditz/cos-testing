...
var status = util.getRandomFFStatus();
var status_label = status.label;
var status_value = status.value;

var def_status = util.getDefaultFFStatus();
var def_status_label = def_status.label;
var def_status_value = def_status.value;

console.log(status_label + " **** " + status_value);
console.log(def_status_label + " **** " + def_status_value);
...
module.exports = {
	...
	'Field appears in RDFData': function(browser) {
		...
		rdfdata
			.verify_textarea_nodeid(contents.replace(def_status_value, status_value), entityid, nodeid);
	},
	...
	'Upload appears in Presenter': function(browser) {
		...
		presenter
			.assert_ff_status(def_status_label);
	},
