...
module.exports = {
	...
	'Field appears in Presenter': function(browser) {
		...
		editor.navigate()
			...
			.set_ps_description(test)
			.set_ps_description_lang(lang_label)
			.select();
		...
		presenter
			.assert_ps_description(test)
			.assert_ps_description_lang(lang_value);
	...
	'Upload appears in Editor': function(browser) {
		...
		editor
			.assert_ps_description(test_upload)
			.assert_ps_description_lang(def_lang_label);
	},
