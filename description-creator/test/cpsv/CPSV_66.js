...
module.exports = {
	...
	'Field appears in Presenter': function(browser) {
		...
		editor.navigate()
			...
			.hc_expand()
			.set_hc_description(test)
			.set_hc_description_lang(lang_label)
			.select();
		...
		presenter
			.assert_hc_description(test)
			.assert_hc_description_lang(lang_value);
	...
	'Upload appears in Presenter': function(browser) {
		...
		presenter
			.assert_hc_description(test_upload)
			.assert_hc_description_lang(def_lang_value);
	},
	...
	'Upload appears in Editor': function(browser) {
		...
		editor
			.assert_hc_description(test_upload)
			.assert_hc_description_lang(def_lang_label);
	},
