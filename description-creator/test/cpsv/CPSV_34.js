...
module.exports = {
	...
	'Field appears in Presenter': function(browser) {
		...
		presenter
			.assert_pa_role(test)
			.assert_pa_role_lang(lang_value);
	...
	'Upload appears in Presenter': function(browser) {
		...
		presenter
			.assert_pa_role(test_upload)
			.assert_pa_role_lang(def_lang_value);
	},
	...
	'Upload appears in Editor': function(browser) {
		...
		editor
			.assert_pa_role(test_upload)
			.assert_pa_role_lang(def_lang_label);
	},
