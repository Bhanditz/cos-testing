...
module.exports = {
	...
	'Field appears in Presenter': function(browser) {
		...
		editor.navigate()
			...
			.ip_expand()
			.set_ip_description(test)
			.set_ip_description_lang(lang_label)
			.select();
		...
		presenter
			.assert_ip_description(test)
			.assert_ip_description_lang(lang_value);
	...
	'Upload appears in Presenter': function(browser) {
		...
		presenter
			.assert_ip_description(test_upload)
			.assert_ip_description_lang(def_lang_value);
	},
	...
	'Upload appears in Editor': function(browser) {
		...
		editor
			.assert_ip_description(test_upload)
			.assert_ip_description_lang(def_lang_label);
	},
