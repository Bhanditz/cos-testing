...
module.exports = {
	...
	'Field appears in Presenter': function(browser) {
		...
		presenter
			.assert_ff_name(test)
			.assert_ff_name_lang(lang_value);
	...
	'Upload appears in Presenter': function(browser) {
		...
		presenter
			.assert_ff_name(test_upload)
			.assert_ff_name_lang(def_lang_value);
	},
	...
	'Upload appears in Editor': function(browser) {
		...
		editor
			.assert_ff_name(test_upload)
			.assert_ff_name_lang(def_lang_label);
	},
