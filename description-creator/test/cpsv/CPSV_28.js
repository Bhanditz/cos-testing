...
module.exports = {
	...
	'Field appears in Presenter': function(browser) {
		...
		presenter
			.assert_cr_type(test)
			.assert_cr_type_lang(lang_value);
	...
	'Upload appears in Presenter': function(browser) {
		...
		presenter
			.assert_cr_type(test_upload)
			.assert_cr_type_lang(def_lang_value);
	},
	...
	'Upload appears in Editor': function(browser) {
		...
		editor
			.assert_cr_type(test_upload)
			.assert_cr_type_lang(def_lang_label);
	},
