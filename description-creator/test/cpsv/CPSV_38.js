...
module.exports = {
	...
	'Field appears in Presenter': function(browser) {
		...
		presenter
			.assert_ip_type(test)
			.assert_ip_type_lang(lang_value);
	...
	'Upload appears in Presenter': function(browser) {
		...
		presenter
			.assert_ip_type(test_upload)
			.assert_ip_type_lang(def_lang_value);
	},
	...
	'Upload appears in Editor': function(browser) {
		...
		editor
			.assert_ip_type(test_upload)
			.assert_ip_type_lang(def_lang_label);
	},
