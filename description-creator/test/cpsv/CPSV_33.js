...
module.exports = {
	...
	'Field appears in Presenter': function(browser) {
		...
		editor.navigate()
			...
			.pa_expand()
			.set_pa_description(test)
			.set_pa_description_lang(lang_label)
			.select();
		...
		presenter
			.assert_pa_description(test)
			.assert_pa_description_lang(lang_value);
	...
	'Upload appears in Presenter': function(browser) {
		...
		presenter
			.assert_pa_description(test_upload)
			.assert_pa_description_lang(def_lang_value);
	},
	...
	'Upload appears in Editor': function(browser) {
		...
		editor
			.assert_pa_description(test_upload)
			.assert_pa_description_lang(def_lang_label);
	},
