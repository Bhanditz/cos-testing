...
module.exports = {
	...
	'Field appears in Presenter': function(browser) {
		...
		editor.navigate()
			...
			.prod_expand()
			.set_prod_description(test)
			.set_prod_description_lang(lang_label)
			.select();
		...
		presenter
			.assert_prod_description(test)
			.assert_prod_description_lang(lang_value);
	...
	'Upload appears in Presenter': function(browser) {
		...
		presenter
			.assert_prod_description(test_upload)
			.assert_prod_description_lang(def_lang_value);
	},
	...
	'Upload appears in Editor': function(browser) {
		...
		editor
			.assert_prod_description(test_upload)
			.assert_prod_description_lang(def_lang_label);
	},
