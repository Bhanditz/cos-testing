...
var status = util.getRandomStatus();
var status_label = status.label;
var status_value = status.value;

var def_status = util.getDefaultStatus();
...
module.exports = {
	...
	'Upload appears in Presenter': function(browser) {
		...
		presenter
			.assert_ps_status(def_status_label);
	},
