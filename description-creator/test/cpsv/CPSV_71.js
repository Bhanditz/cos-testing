...
module.exports = {
	...
	'Field appears in Presenter': function(browser) {
		...
		editor.navigate()
			...
			.ida_expand()
			.set_ida_landingpage(test)
			.set_ida_landingpage_lang(lang_label)
			.select();
		...
		presenter
			.assert_ida_landingpage(test)
			.assert_ida_landingpage_lang(lang_value);
	...
	'Upload appears in Presenter': function(browser) {
		...
		presenter
			.assert_ida_landingpage(test_upload)
			.assert_ida_landingpage_lang(def_lang_value);
	},
	...
	'Upload appears in Editor': function(browser) {
		...
		editor
			.assert_ida_landingpage(test_upload)
			.assert_ida_landingpage_lang(def_lang_label);
	},
