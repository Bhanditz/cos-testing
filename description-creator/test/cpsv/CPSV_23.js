...
module.exports = {
	...
	'Field appears in Presenter': function(browser) {
		...
		editor.navigate()
			...
			.le_expand()
			.set_le_description(test)
			.set_le_description_lang(lang_label)
			.select();
		...
		presenter
			.assert_le_description(test)
			.assert_le_description_lang(lang_value);
	...
	'Upload appears in Presenter': function(browser) {
		...
		presenter
			.assert_le_description(test_upload)
			.assert_le_description_lang(def_lang_value);
	},
	...
	'Upload appears in Editor': function(browser) {
		...
		editor
			.assert_le_description(test_upload)
			.assert_le_description_lang(def_lang_label);
	},
