...
module.exports = {
	...
	'Field appears in Presenter': function(browser) {
		...
		editor.navigate()
			...
			.ff_expand()
			.set_ff_description(test)
			.set_ff_description_lang(lang_label)
			.select();
		...
		presenter
			.assert_ff_description(test)
			.assert_ff_description_lang(lang_value);
	...
	'Upload appears in Presenter': function(browser) {
		...
		presenter
			.assert_ff_description(test_upload)
			.assert_ff_description_lang(def_lang_value);
	},
	...
	'Upload appears in Editor': function(browser) {
		...
		editor
			.assert_ff_description(test_upload)
			.assert_ff_description_lang(def_lang_label);
	},
